...
export default async function AdminGuide({ lang }: { lang: string }) {
  ...
  // NOT requireClan(). The guide index renders on the apex and links straight here, so
  // demanding a clan makes every guide a 404 for the reader most likely to want it.
  ...
  // paragraph about it.
  const hosted = getOAuthMode() !== 'none';
